...
void main() {
  ...
  // Alternate coding seems to run a bit slower:
  //
  // #ifdef USE_ARRAY
  // vec3[](
  // vec3 rawNormal = 
  //   vec3(0, 0, 1), 
  //   vec3(0, 0, -1), 
  //   vec3(u[2][0] / u[2][3] - u[1][0] / u[1][3], u[2][1] / u[2][3] - u[1][1] / u[1][3], 0), 
  //   vec3(u[3][0] / u[3][3] - u[0][0] / u[0][3], u[3][1] / u[3][3] - u[0][1] / u[0][3], 0), 
  //   vec3(u[1][0] / u[1][3] - u[2][0] / u[2][3], u[1][1] / u[1][3] - u[2][1] / u[2][3], 0), 
  //   vec3(u[0][0] / u[0][3] - u[3][0] / u[3][3], u[0][1] / u[0][3] - u[3][1] / u[3][3], 0))[inNormalRef];
  // #else
  vec3 rawNormal = 
